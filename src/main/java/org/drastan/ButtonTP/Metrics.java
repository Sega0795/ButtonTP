...
public class Metrics {
     ...
     */
    private volatile BukkitTask taskId = new BukkitTask() {
    ...
    public Metrics(final Plugin plugin) throws IOException {
        ...
        List<String> urlBase = new ArrayList<String>();
        
        urlBase.add("http://mcstats.org");
        ...
        if (configuration.get("guid", null) == null) {
            configuration.options().setHeader(urlBase).copyDefaults(true);
    ...
    */
     ...
     */
    private void postPlugin(final boolean isPing) throws IOException, URISyntaxException {
        ...
        // Create the url
        URI uri = new URI(BASE_URL + String.format(REPORT_URL, encode(plugin.getDescription().getName())));
        URL url = uri.toURL();
